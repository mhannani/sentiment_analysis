...
if __name__ == "__main__":
    ...
    # add arguments
    parser.add_argument('preprocessed_corpus_json', type=str, help='The filename of preprocessed_corpus_json.')
    ...
    # read json data
    json_data = read_json(preprocessed_corpus_json_path)

    # output json
    output_tsv = Path(output_root) / f"results_of_{args.preprocessed_corpus_json}.csv"
